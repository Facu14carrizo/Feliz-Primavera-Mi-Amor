...
const STAGES = [
  ...
  },
  {
    ...
    stemHeight: 50,
    visibleLeaves: 1,
    reasons: ["Sos mi solcito radiante ☀️"],
    showTitle: true,
    showSpecial: false,
    btnText: "Un poco más de luz",
    btnEmoji: "💧"
  },
  {
    ...
    stemHeight: 110,
    visibleLeaves: 2,
    reasons: ["Sos mi solcito radiante ☀️", "Tenés la sonrisa más hermosa 💛"],
    showTitle: true,
    showSpecial: false,
    btnText: "Sigue creciendo",
    btnEmoji: "🌱"
  },
  {
    ...
    stemHeight: 170,
    visibleLeaves: 2,
    reasons: ["Sos mi solcito radiante ☀️", "Tenés la sonrisa más hermosa 💛", "Llenás todos mis días de luz ✨"],
    showTitle: true,
    showSpecial: false,
    btnText: "Sigue creciendo",
    btnEmoji: "🌱"
  },
  {
    ...
    stemHeight: 170,
    visibleLeaves: 3,
    reasons: ["Sos mi solcito radiante ☀️", "Tenés la sonrisa más hermosa 💛", "Llenás todos mis días de luz ✨", "Sos mi persona favorita en el universo 💖"],
    showTitle: true,
    showSpecial: false,
    btnText: "Sigue creciendo",
    btnEmoji: "🌱"
  },
  {
    ...
    stemHeight: 225,
    visibleLeaves: 4,
    reasons: ["Sos mi solcito radiante ☀️", "Tenés la sonrisa más hermosa 💛", "Llenás todos mis días de luz ✨", "Sos mi persona favorita en el universo 💖", "Hacés mi mundo perfecto 🌻"],
    showTitle: true,
    showSpecial: true,
    btnText: "Regar con todo mi amor",
    btnEmoji: "💛",
    triggersModal: true
  }
];
